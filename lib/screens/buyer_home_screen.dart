...
class _BuyerHomeScreenState extends State<BuyerHomeScreen>
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    if (dealStatus == null) ...[
                      const Text(
                        "Bantu pengguna lain dengan ulasanmu!",
                        textAlign: TextAlign.center,
  ...
  void _handleSubmitReview(CommodityPost post, double rating, String review) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          "Terima kasih telah membantu komunitas PanenLokal.",
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
  ...
  Widget _buildPendingReviewCard() {
    if (!_waitingForReview || _pendingReviewPost == null)
      return const SizedBox.shrink();
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Berikan ulasan untuk membantu yang lain!",
