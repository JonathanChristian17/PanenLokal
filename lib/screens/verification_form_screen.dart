...
import 'profile_screen.dart'; // Tetap diimpor untuk tombol kembali, meskipun nanti akan di-pop
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (success) {
                  ...
                  // ✅ PERBAIKAN NAVIGASI: Cukup pop untuk kembali ke ProfileScreen 
                  // yang memiliki Navbar di stack bawahnya.
                  Navigator.pop(context); 

                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("Gagal mengirim ke server! Periksa log!")),
                  );
                }
              },
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        // ✅ PERBAIKAN NAVIGASI: Cukup pop() saat tombol kembali ditekan
                        Navigator.pop(context);
                      },
                    ),
